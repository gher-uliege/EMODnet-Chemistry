...
attrib_dict = Dict(
	...
	"comment" => "Every year of the time corresponds to a 6-year running average for the corresponding season: Autumn (Sep-Nov), Winter (Dec-Feb), Spring (Mar-May) and Summer (Jun-Aug). Horizontal resolution 0.2°.",
