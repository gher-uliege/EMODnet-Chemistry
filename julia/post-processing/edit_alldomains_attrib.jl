...
function edit_global_att(datafile::String)
  NCDatasets.Dataset(datafile, "a") do ds
    ...
    ds.attrib["DIVAnd_references"] = "Barth, A.; Beckers, J.-M.; Troupin, C.; Alvera-Azcárate, A. & Vandenbulcke, L. divand-1.0: n-dimensional variational data analysis for ocean observations. Geoscientific Model Development, 2014, 7, 225-241. DOI: :10.5194/gmd-7-225-2014" ;
