...
varlist = ["Water body dissolved inorganic nitrogen"]

# Set input and output directories
inputdir = "/home/ctroupin/data/EMODnet-Chemistry/Eutrophication2024/ODVnetCDF/"
outputdir = "/home/ctroupin/data/EMODnet-Chemistry/Eutrophication2024/netCDF222"
...
datafilesdict = Dict(
   "data_from_Eutrophication_MED_timeseries_6.2024.nc" => "MediterraneanTS",
#"data_from_North_Sea_eutrhophication_timeseries_20240529.nc" => "NorthSeaTS"
)
      ...
      for varname in varlist
         ...
         if !isfile(outputfile)
            ...
            try
               ...
               @info("Writing new netCDF file $(outputfile)")
